...
class ProductNotification extends Action
{
    ...
    /**
     * Execute controller to render ProductNotification template variables HTML block
     *
    ...
    public function execute()
    {
        ...
        $block = $layout->createBlock(
            \Azguards\WhatsAppConnect\Block\Adminhtml\Config\Form\Field\ProductNotification::class
        )->setTemplate(
