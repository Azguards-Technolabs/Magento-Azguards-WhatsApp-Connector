...
class UserRegistration extends Action
{
    ...
    public function __construct(
     ...
     /**
      * Execute controller to render UserRegistration template variables HTML block
      *
    ...
    public function execute()
    {
        ...
        $block = $layout->createBlock(
            \Azguards\WhatsAppConnect\Block\Adminhtml\Config\Form\Field\UserRegistration::class
        )->setTemplate(
