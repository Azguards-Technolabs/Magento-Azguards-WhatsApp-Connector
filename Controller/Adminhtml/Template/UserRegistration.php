...
class UserRegistration extends Action
{
    ...
    public function execute()
    {
        ...
        $block = $layout->createBlock(\Azguards\WhatsAppConnect\Block\Adminhtml\Config\Form\Field\UserRegistration::class)->setTemplate('Azguards_WhatsAppConnect::config/form/field/userRegistration.phtml')->setData('template_id', $templateId)->setData('field_id', $fieldId)->setData('options', $templateVerible);
