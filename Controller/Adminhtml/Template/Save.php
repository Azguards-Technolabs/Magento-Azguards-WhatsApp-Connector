                ...
                if (isset($data['carousel_cards']) && is_array($data['carousel_cards'])) {
                    ...
                    foreach ($cards as $index => &$card) {
                        ...
                        if (isset($card['buttons']) && is_array($card['buttons'])) {
                            if (isset($card['buttons']['record'])) {
                                unset($card['buttons']['record']);
                            }
                            $card['buttons'] = array_values(array_filter(
                                $card['buttons'],
                                static fn ($button) => is_array($button) && !empty(array_filter($button, static fn ($value) => $value !== '' && $value !== null))
                            ));
