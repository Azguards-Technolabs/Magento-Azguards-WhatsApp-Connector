...
{
    public const XML_PATH_SEARCHABLE_DROPDOWN_ORDER_CREDIT_MEMO = "whatsApp_conector/order_credit_memo/searchable_dropdown_order_credit_memo";
    public const XML_PATH_ORDER_CREDIT_MEMO_VERIABLE = "whatsApp_conector/order_credit_memo/order_credit_memo_variable";
    ...
    public function execute(Observer $observer)
    {
        try {
            ...
            $creditMemoTempaletId = $this->apiHelper->getConfigValue(self::XML_PATH_SEARCHABLE_DROPDOWN_ORDER_CREDIT_MEMO);
            $creditMemoTempaletVerible = $this->apiHelper->getConfigValue(self::XML_PATH_ORDER_CREDIT_MEMO_VERIABLE);
            ...
            if ($creditMemoTempaletId && $enable) {
                ...
                $response = $this->apiHelper->sendMessage($creditMemoTempaletId, $tempaletVeribleDetails, 'CreateRefundAfter', $userDetail);
            }
        } catch (\Exception $e) {
