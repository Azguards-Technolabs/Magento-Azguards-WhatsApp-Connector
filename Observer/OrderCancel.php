...
{
    public const XML_PATH_SEARCHABLE_DROPDOWN_ORDER_CANCEL = "whatsApp_conector/order_cancellation/searchable_dropdown_order_cancellation";
    public const XML_PATH_ORDER_CANCEL_VERIBLE = "whatsApp_conector/order_cancellation/order_cancellation_variable";
    ...
    public function execute(Observer $observer)
    {
        try {
            ...
            $orderCancelTempaletId = $this->apiHelper->getConfigValue(self::XML_PATH_SEARCHABLE_DROPDOWN_ORDER_CANCEL);
            $tempaletVerible = $this->apiHelper->getConfigValue(self::XML_PATH_ORDER_CANCEL_VERIBLE);
            ...
            if ($orderCancelTempaletId && $enable) {
                ...
                $customerData = $this->apiHelper->getCustomerDetails($order, $orderCancelTempaletId);
                $this->apiHelper->sendMessage($orderCancelTempaletId, $tempaletVeribleDetails, 'OrderCancel', $userDetail);
            }
        } catch (\Exception $e) {
