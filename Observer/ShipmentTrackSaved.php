...
/**
 * Observer for shipment track saved event.
 */
    ...
    public function execute(Observer $observer): void
    {
        try {
            ...
            if ((int)$firstTrack->getId() !== (int)$track->getEntityId()) {
                $this->logger->info(sprintf(
                    'ShipmentTrackSaved skipped duplicate shipment notification. shipment_id=%s ' .
                    'track_id=%s first_track_id=%s',
                    (string)$shipment->getEntityId(),
                    (string)$track->getEntityId(),
                    (string)$firstTrack->getId()
                ));
            ...
            $this->logger->info(sprintf(
                'ShipmentTrackSaved notifyShipmentCreated completed. shipment_id=%s track_id=%s ' .
                'success=%s message=%s',
                (string)$shipment->getEntityId(),
                (string)$track->getEntityId(),
