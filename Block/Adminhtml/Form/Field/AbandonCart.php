...
class AbandonCart extends Field implements RendererInterface
{
    ...
    public function render(AbstractElement $element)
    {
        ...
        $html .= '<select id="' . $element->getHtmlId() . '" name="' . $element->getName() . '" class="admin__control-select searchable-dropdown-abandon-cart">';
        ...
        <script>
            require(["jquery", "select2"], function($) {
                $(document).ready(function() {
                    var dropdown = $(".searchable-dropdown-abandon-cart");
                    ...
                    dropdown.on("change", function(e) {
                        ...
                        if (selectedValue) {
                            jQuery.ajax({
                                ...
                                type: "POST",
                                data: { template_id: selectedValue, field_id: selectedId, requesrUrl: "orderShipment" },
                                showLoader: true,
    ...
    {
        return $this->urlInterface->getUrl('whatsappconnect/template/abandoncart');
    }
