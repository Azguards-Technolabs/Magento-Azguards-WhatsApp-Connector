...
class ProductNotification extends Field implements RendererInterface
{
    /**
     * @var ApiHelper
     */
    ...
    public function render(AbstractElement $element)
    {
        ...
        $html .= '<select id="' . $element->getHtmlId() . '" name="' . $element->getName()
            . '" class="admin__control-select searchable-dropdown-product-notification">';
    ...
    {
        return $this->urlInterface->getUrl('whatsappconnect/template/productnotification');
    }
