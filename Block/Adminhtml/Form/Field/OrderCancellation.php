...
class OrderCancellation extends Field implements RendererInterface
{
    ...
    public function render(AbstractElement $element)
    {
        ...
        $html .= '<select id="' . $element->getHtmlId() . '" name="' . $element->getName() . '" class="admin__control-select searchable-dropdown-cancel">';
                    ...
                    dropdown.on("change", function(e) {
                        ...
                        if (selectedValue) {
                            jQuery.ajax({
                                ...
                                type: "POST",
                                data: { template_id: selectedValue, field_id: selectedId, requesrUrl: "orderCancel" },
                                showLoader: true,
    ...
    {
        return $this->urlInterface->getUrl('whatsappconnect/template/ordercancellation');
    }
