...
class OrderShipment extends Field implements RendererInterface
{
    ...
    public function render(AbstractElement $element)
    {
        ...
        $html .= '<select id="' . $element->getHtmlId() . '" name="' . $element->getName() . '" class="admin__control-select searchable-dropdown-shipment">';
        ...
        <script>
            require(["jquery", "select2"], function($) {
                $(document).ready(function() {
                    var dropdown = $(".searchable-dropdown-shipment");
    ...
    {
        return $this->urlInterface->getUrl('whatsappconnect/template/ordershipment');
    }
