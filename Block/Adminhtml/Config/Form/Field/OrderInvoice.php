...
class OrderInvoice extends Field
{
    ...
    public function getDropdownOptions()
    {
        return [
            ...
            // Invoice Order Attributes
            'invoice_id' => __('Invoice ID'),
            'increment_id' => __('Invoice Number'),
            'created_at' => __('Invoice Created At'),
            'updated_at' => __('Invoice Updated At'),
            'grand_total' => __('Invoice Total'),
            'subtotal' => __('Invoice Subtotal'),
            'tax_amount' => __('Invoice Tax Amount'),
            'shipping_amount' => __('Invoice Shipping Amount'),
            'state' => __('Invoice Status'),
        ];
    }
    /**
     * {@inheritdoc}
