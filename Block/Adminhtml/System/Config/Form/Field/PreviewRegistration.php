                    ...
                    [
                        ...
                        'variables' => [
                            ...
                            [
                                'label' => __('Created At'),
                                'badge' => 'created_at',
                                'value' => '{{var customer.created_at}}'
                            ],
                            [
                                'label' => __('Updated At'),
                                'badge' => 'updated_at',
                                'value' => '{{var customer.updated_at}}'
                            ],
                            [
                                'label' => __('Created In'),
                                'badge' => 'created_in',
                    ...
                    [
                        ...
                        'variables' => [
                            ...
                            [
                                ...
                                'value' => '{{var address.is_default_billing}}'
                            ],
                            [
                                'label' => __('Is Default Shipping'),
                                'badge' => 'is_default_shipping',
                                'value' => '{{var address.is_default_shipping}}'
                            ],
                        ]
                    ]
                ]
