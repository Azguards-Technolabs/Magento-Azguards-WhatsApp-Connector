...
class PreviewCancellation extends Preview
{
    ...
    public function getBuilderConfigJson(): string
    {
        return $this->json->serialize([
            'selectors' => [
                'headerType' => '#whatsapp_template_order_cancellation_template_header_type',
                'headerText' => '#whatsapp_template_order_cancellation_template_header_text',
                'bodyTemplate' => '#whatsapp_template_order_cancellation_template_body_template',
                'footerTemplate' => '#whatsapp_template_order_cancellation_template_footer_template',
                'templateName' => '#whatsapp_template_order_cancellation_template_template_name',
                'category' => '#whatsapp_template_order_cancellation_template_category',
                'language' => '#whatsapp_template_order_cancellation_template_language',
                'headerHandle' => '#whatsapp_template_order_cancellation_template_header_handle',
                'headerImage' => '#whatsapp_template_order_cancellation_template_header_image',
                'buttonsJson' => '#whatsapp_template_order_cancellation_template_buttons_json',
                'eventCodeInput' => '#whatsapp_template_order_cancellation_template_event_code',
